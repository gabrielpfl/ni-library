...
export class MatDaterangepicker<D> extends MatDatepicker<D> implements OnInit, AfterViewInit, OnDestroy {
	...
	ngAfterViewInit(){
		// Object.defineProperty(this._datepickerInput, 'value', {
		//   set: (value: D | null) => {
		// 	console.log('from '+value)
		//     value = this._datepickerInput._dateAdapter.deserialize(value);
		//     this._datepickerInput['_lastValueValid'] = !value || this._datepickerInput._dateAdapter.isValid(value);
		//     value = this._datepickerInput['_getValidDateOrNull'](value);
		// 	const oldDate = this['value'];
		//     (<any>this._datepickerInput)._assignValue(value);
		//     (<any>this._datepickerInput)._formatValue(value);

		//     if (!this._datepickerInput._dateAdapter.sameDate(oldDate, value)) {
		//       this._datepickerInput._valueChange.emit(value);
		//     }
		//   }
	}
